...
public class EmpresaService {
    ...
    public ResponseEntity<List<EmpresaEntity>> ListarEmpresaCliente()
    {
        try
        {
            ...
            List<EmpresaEntity>empresaEntitiesfilter = new ArrayList<>();
            for(EmpresaEntity entity : empresaEntities)
            {
                if(entity.getTipocadastro() == TIPOCADASTRO.CLIENTE)
                {
                    empresaEntitiesfilter.add(entity);
                }
            }
        }
        catch (Exception e)
    ...
    public ResponseEntity<List<EmpresaEntity>> ListarEmpresaFornecedor()
    {
        try
        {
            ...
            for(EmpresaEntity entity : empresaEntities)
            {
                if(entity.getTipocadastro() == TIPOCADASTRO.PROPRIETARIO)
                {
                    empresaEntitiesfilter.add(entity);
                }
            }
    ...
    public ResponseEntity<List<EmpresaEntity>> ListarEmpresaPropritario()
    {
        try
        {
            ...
            for(EmpresaEntity entity : empresaEntities)
            {
                if(entity.getTipocadastro() == TIPOCADASTRO.FORNECEDOR)
                {
                    empresaEntitiesfilter.add(entity);
                }
            }
